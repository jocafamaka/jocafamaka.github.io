  ...
  */
  ...
  function showMenu(){
    swal({
      ...
      inputOptions:{
        '0': '<img class="al122x122 grow load" title="Project on GitHub" onclick="window.open(\'https://github.com/jocafamaka/nagmapReborn\'); swal.close();" src="resources/img/project.png">',
        '1': '<img class="al122x122 grow load" title="Change" onclick="change();" src="resources/img/reset.png">'
      }
    })
  };
